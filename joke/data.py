...
JOKES: List[Dict[str, Union[int, str]]] = [
    ...
    {
        "id": 8,
        "joke": "Did you hear about the highly addictive new restaurant? People are saying it's crack-er barrel.",
    },
    {
        "id": 9,
        "joke": "My wife asked me to stop singing 'Wonderwall' to her. I said maybe...",
    },
]
